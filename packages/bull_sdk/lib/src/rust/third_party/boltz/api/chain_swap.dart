...
class ChainSwap {
  ...
  }) => BullSdk.instance.api.boltzApiChainSwapChainSwapBroadcastBoltz(
    that: this,
    signedHex: signedHex,
    kind: kind,
  );
  ...
  }) => BullSdk.instance.api.boltzApiChainSwapChainSwapBroadcastLocal(
    that: this,
    signedHex: signedHex,
    kind: kind,
    electrumSettings: electrumSettings,
  ...
  }) => BullSdk.instance.api.boltzApiChainSwapChainSwapClaim(
    that: this,
  ...
  Future<BigInt> claimTxSize({
    ...
    ElectrumSettings? btcElectrumSettings,
    ElectrumSettings? lbtcElectrumSettings,
  }) => BullSdk.instance.api.boltzApiChainSwapChainSwapClaimTxSize(
    that: this,
    outAddress: outAddress,
    tryCooperate: tryCooperate,
    btcElectrumSettings: btcElectrumSettings,
  ...
  static Future<ChainSwap> fromJson({required String jsonStr}) =>
      BullSdk.instance.api.boltzApiChainSwapChainSwapFromJson(jsonStr: jsonStr);

  /// Get the transaction id of the server's lockup transaction
  Future<String> getServerLockup() => BullSdk.instance.api
      .boltzApiChainSwapChainSwapGetServerLockup(that: this);

  /// Get the transaction id of the user's lockup transaction
  Future<String> getUserLockup() =>
      BullSdk.instance.api.boltzApiChainSwapChainSwapGetUserLockup(that: this);
  ...
  }) => BullSdk.instance.api.boltzApiChainSwapChainSwapNew(
    id: id,
    isTestnet: isTestnet,
    direction: direction,
  ...
  Future<String> refund({
    ...
    ElectrumSettings? btcElectrumSettings,
    ElectrumSettings? lbtcElectrumSettings,
  }) => BullSdk.instance.api.boltzApiChainSwapChainSwapRefund(
    that: this,
  ...
  Future<BigInt> refundTxSize({
    ...
    ElectrumSettings? btcElectrumSettings,
    ElectrumSettings? lbtcElectrumSettings,
  }) => BullSdk.instance.api.boltzApiChainSwapChainSwapRefundTxSize(
    that: this,
    refundAddress: refundAddress,
    tryCooperate: tryCooperate,
    btcElectrumSettings: btcElectrumSettings,
  ...
  Future<String> toJson() =>
      BullSdk.instance.api.boltzApiChainSwapChainSwapToJson(that: this);
