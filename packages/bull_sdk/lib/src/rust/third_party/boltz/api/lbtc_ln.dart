...
class LbtcLnSwap {
  ...
  Future<String> broadcastBoltz({required String signedHex}) => BullSdk
      .instance
      .api
      .boltzApiLbtcLnLbtcLnSwapBroadcastBoltz(that: this, signedHex: signedHex);
  ...
  }) => BullSdk.instance.api.boltzApiLbtcLnLbtcLnSwapBroadcastLocal(
    that: this,
    signedHex: signedHex,
    electrumSettings: electrumSettings,
  );
  ...
  Future<String> claim({
    ...
    ElectrumSettings? electrumSettings,
  }) => BullSdk.instance.api.boltzApiLbtcLnLbtcLnSwapClaim(
    that: this,
  ...
  Future<BigInt> claimTxSize({
    ...
    ElectrumSettings? electrumSettings,
  }) => BullSdk.instance.api.boltzApiLbtcLnLbtcLnSwapClaimTxSize(
    that: this,
  ...
  Future<void> coopCloseSubmarine() => BullSdk.instance.api
      .boltzApiLbtcLnLbtcLnSwapCoopCloseSubmarine(that: this);

  /// Parse from a JSON string.
  static Future<LbtcLnSwap> fromJson({required String jsonStr}) =>
      BullSdk.instance.api.boltzApiLbtcLnLbtcLnSwapFromJson(jsonStr: jsonStr);

  /// Retrieves the preimage for a completed submarine swap.
  Future<String> getCompletedSubmarinePreimage() => BullSdk.instance.api
      .boltzApiLbtcLnLbtcLnSwapGetCompletedSubmarinePreimage(that: this);

  /// Get the preimage of the lightning invoice for a submarine swap
  Future<String> getPreimage() =>
      BullSdk.instance.api.boltzApiLbtcLnLbtcLnSwapGetPreimage(that: this);
  ...
  static Future<LbtcLnSwap> newInstance({
    ...
    String? referralId,
  }) => BullSdk.instance.api.boltzApiLbtcLnLbtcLnSwapNew(
    id: id,
    kind: kind,
    network: network,
    keys: keys,
  ...
  Future<String> refund({
    ...
    required bool tryCooperate,
    ElectrumSettings? electrumSettings,
  }) => BullSdk.instance.api.boltzApiLbtcLnLbtcLnSwapRefund(
    that: this,
    outAddress: outAddress,
    minerFee: minerFee,
    tryCooperate: tryCooperate,
  ...
  Future<BigInt> refundTxSize({
    required bool isCooperative,
    ElectrumSettings? electrumSettings,
  }) => BullSdk.instance.api.boltzApiLbtcLnLbtcLnSwapRefundTxSize(
    that: this,
    isCooperative: isCooperative,
    electrumSettings: electrumSettings,
  );
  ...
  Future<String> toJson() =>
      BullSdk.instance.api.boltzApiLbtcLnLbtcLnSwapToJson(that: this);
