...
enum Encoding {
  ...
  Future<int> asByte() =>
      BullSdk.instance.api.bbqrEncodeEncodingAsByte(that: this);

  static Future<Encoding?> fromByte({required int byte}) =>
      BullSdk.instance.api.bbqrEncodeEncodingFromByte(byte: byte);

  static Future<bool> isKnownEncoding({required int byte}) =>
      BullSdk.instance.api.bbqrEncodeEncodingIsKnownEncoding(byte: byte);

  Future<BigInt> splitMod() =>
      BullSdk.instance.api.bbqrEncodeEncodingSplitMod(that: this);
}
